...
<body>
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            <div class="navbar-brand"><a href="?">NBD ADMIN</a></div>
            <div class="nav-right ">
                <div class="btn-group mr-auto">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{'admin/post/add'}}">Thêm bài viết</a>
                        <a class="dropdown-item" href="{{'admin/post/product'}}">Thêm sản phẩm</a>
                        <a class="dropdown-item" href="{{'admin/order/list'}}">Thêm đơn hàng</a>
                    </div>
                </div>
                <div class="btn-group">
            ...
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link active">
                        <a href="{{url('admin/product/cat/list')}}">
                            <div class="nav-link-icon d-inline-flex">
                                <i class="far fa-folder"></i>
                            </div>
                            Sản phẩm
